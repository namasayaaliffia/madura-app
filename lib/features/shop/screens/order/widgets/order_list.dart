                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '18 November 2024', style: Theme.of(context).textTheme.headlineSmall,
                      )
                    ],
                  ),
                ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '[#234f3]', style: Theme.of(context).textTheme.titleMedium,
                            )
                          ],
                        ),
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '15 November 2024', style: Theme.of(context).textTheme.titleMedium,
                            )
                          ],
                        ),
                      ),
